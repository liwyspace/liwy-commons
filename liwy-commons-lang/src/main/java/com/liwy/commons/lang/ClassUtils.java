 ...
 *
 * <ul>
 *  <li><b>getShortClassName</b>
 *      - 获取Class的简短名称，与getSimpleName在内部类上有些不同</li>
 *  <li><b>getAllSuperclasses</b>
 *      - 获取所有祖先类</li>
 *  <li><b>getAllInterfaces</b>
 *      - 获取所有祖先类的所有接口</li>
 *  <li><b>convertClassNamesToClasses</b>
 *      - 将ClassName转换为Class</li>
 *  <li><b>convertClassesToClassNames</b>
 *      - 将Class转换为ClassName</li>
 *  <li><b>isPrimitiveOrWrapper</b>
 *      - 是否是基本类型或包装类</li>
 *  <li><b>isPrimitiveWrapper</b>
 *      - 是否是基本类型</li>
 *  <li><b>primitiveToWrapper</b>
 *      - 基本类型转包装类</li>
 *  <li><b>wrapperToPrimitive</b>
 *      - 包装类转基本类型</li>
 *  <li><b>isInnerClass</b>
 *      - 是否为内部类</li>
 *  <li><b>getClass</b>
...
public class ClassUtils {
    ...
    /**
     * 判断是否为基本类型的包装类： ({@link Boolean}, {@link Byte}, {@link Character}, {@link Short},
     ...
     *
     * @param cls  待校验的Class
     * @return 如果是内部类或匿名内部类则返回true
     *  如果不是或者是{@code null}则返回false
     */
